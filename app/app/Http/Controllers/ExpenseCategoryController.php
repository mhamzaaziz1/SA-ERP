...
class ExpenseCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['name', 'code', 'unit']);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                $expense_category->unit = $input['unit'];
    ...
    public function destroy($id)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                $sub_categorys = sub_category::where('business_id', $business_id)->where('category_id', $id)->get();
