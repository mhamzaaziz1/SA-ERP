        ...
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
                @if(auth()->user()->can('all_expense.access'))
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('expense_for', __('Expense Requester').':') !!}
                            {!! Form::select('expense_for', $users, null, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('expense_contact_filter',  __('Supplier') . ':') !!}
                ...
                <div class="col-md-3">
                   ...
                   <!-- <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('sub_category_id',__('Expense sub category').':') !!}
                        {!! Form::select('sub_category_id', $sub_category, null, ['placeholder' =>
                        __('report.all'), 'class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'sub_category_id']); !!}
                    </div>
                </div> -->
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('expensebeneficiary_id',__('Expense Beneficiary').':') !!}
                        {!! Form::select('expensebeneficiary_id', $expensebeneficiary, null, ['placeholder' =>
                        __('report.all'), 'class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'expensebeneficiary_id']); !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                    ...
                    <table class="table table-bordered table-striped" id="expense_table">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('Expense Beneficiary')</th>                              
