...
<div class="payment_details_div @if( $payment_line['method'] !== 'cheque' ) {{ 'hide' }} @endif" data-type="cheque" >
	...
	<div class="col-md-4">
		<div class="form-group">
			{!! Form::label("bank_name_$row_index",__('Bank Name.')) !!}
			{!! Form::text("payment[$row_index][bank_name]", $payment_line['bank_name'], ['class' => 'form-control', 'placeholder' => __('bank name'), 'id' => "bank_name_$row_index"]); !!}
		</div>
	</div>
		<div class="col-md-4">
		<div class="form-group">
			{!! Form::label("branch_code_$row_index",__('Branch Code.')) !!}
			{!! Form::number("payment[$row_index][branch_code]", $payment_line['branch_code'], ['class' => 'form-control', 'placeholder' => __('branch code'), 'id' => "branch_code_$row_index"]); !!}
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
			{!! Form::label("cheque_due_date_$row_index",__('Cheque Due date.')) !!}
			{!! Form::date("payment[$row_index][cheque_due_date]", $payment_line['cheque_due_date'], ['class' => 'form-control', 'placeholder' => __('cheque due date'), 'id' => "cheque_due_date_$row_index"]); !!}
		</div>
	</div>
</div>
