    ...
    <body>
		...
		@php
						...
						@endphp
								...
								@php
								$totaltax=$totaltax+((float) filter_var( $val, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ))
								@endphp
	            				@endforeach
@php
...
@endphp
            ...
            $totaltax1=0;
						@endphp
	            				...
	            				@endforeach
						@php
						$totaltax1=' '.$totaltax.' '.substr($receipt_details->subtotal, -4);
						@endphp
	            				</table>
					<div class="flex-box">
						<p class="width-50 text-right">
...
use Salla\ZATCA\Tags\TaxNumber;
	...
	$qrcode = GenerateQrCode::fromArray([
    			...
    			new InvoiceTaxAmount($totaltax1) // invoice tax amount
