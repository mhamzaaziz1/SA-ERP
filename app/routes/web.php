...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/contacts/print/{id}', 'TransactionPaymentController@printPayContactDue');
    ...
    Route::resource('expense-sub-categories', 'SubCategoryController');
    Route::get('expense-sub-create', 'SubCategoryController@create');

    Route::resource('expense-beneficiary', 'ExpenseBeneficiaryController');

    //Expenses...
    Route::resource('expenses', 'ExpenseController');
    Route::get('get_subCategory', 'ExpenseController@get_subCategory');
    // Route::post('saveexpenses', 'ExpenseController@store');
    ...
    Route::get('/payments/expense-payment/{payment_id}', 'TransactionPaymentController@expensePayment');
    ...
    Route::resource('bookings', 'Restaurant\BookingController');
     ...
     Route::get('get-todays-cheque', 'CheckManagementController@getTodaysCheque');
    Route::resource('checkmanagement', 'CheckManagementController');
